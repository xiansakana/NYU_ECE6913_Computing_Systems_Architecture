...
class FiveStageCore(Core):
    def __init__(self, ioDir, imem, dmem, outputDir):
        super(FiveStageCore, self).__init__(os.path.join(outputDir, "FS_"), imem, dmem)
        self.opFilePath = os.path.join(outputDir, "StateResult_FS.txt")
...
if __name__ == "__main__":
    ...
    output_dir = os.path.join(ioDir, "output")
    ...
    for test_case_folder in os.listdir(os.path.join(ioDir, "input")):
        if os.path.isdir(os.path.join(ioDir, "input", test_case_folder)):
            ...
            fsCore = FiveStageCore(os.path.join(ioDir, "input", test_case_folder), imem, dmem_fs, output_test_case_dir)
            ...
            dmem_fs.outputDataMem(output_test_case_dir)
            ...
            Generate_Metrics().generate("a", "Metrics for FS:", fsCore.cycle, ssCore.cycle-1, output_test_case_dir)
